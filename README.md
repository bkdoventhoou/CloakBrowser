...
> **Personal note:** I mostly use this with `headless=False` while debugging scrapers so I can actually see what's happening in the browser. Flip it to `True` once things are working.
